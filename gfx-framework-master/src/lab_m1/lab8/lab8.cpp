...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        myLightPosition = glm::vec3(0, 1, 1);
...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.6, 0.5, 0.4));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.6, 0.5, 0.4));
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.6, 0.5, 0.4));
...
void Lab8::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    int my_light_position = glGetUniformLocation(shader->program, "my_light_position");
    glUniform3f(my_light_position, myLightPosition.x, myLightPosition.y, myLightPosition.z);
